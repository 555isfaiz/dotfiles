...
-- Var
local width = dpi(410)
local height = awful.screen.focused().geometry.height - dpi(80)
...
local vol__ = box_widget(vol_, 380, 60)
...
sidebar.toggle = function()
	...
	--	aa.timer:start()
		slide.target = awful.screen.focused().geometry.x + dpi(12)
		sidebar.visible = not sidebar.visible
	end
end
...
-- helpers.click2hide.popup(sidebar, function ()
--   sidebar.toggle()
-- end, true)
