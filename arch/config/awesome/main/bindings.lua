...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey, }, "Tab", function() awful.spawn("rofi -show window -window-format '{c} {t} {n} '") end,
        { description = "show windows", group = "tag" }),
})
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({ modkey, "Mod1"}, "Left",
        ...
        { description = "Prev tab", group = "bling" }),
        
    awful.key({ modkey, "Mod1"}, "Right",
        function()
            bling.module.tabbed.iter(1)
        end,
        { description = "Next tab", group = "bling" }),
    ...
    awful.key({ modkey, }, "Left",
        ...
        { description = "focus left", group = "tag" }),
    ...
    awful.key({ modkey, }, "Right",
        ...
        { description = "focus right", group = "tag" }),

    awful.key({ modkey, }, "Up",
        function()
            awful.client.focus.bydirection("up")
        end,
        { description = "focus up", group = "tag" }),

    awful.key({ modkey, }, "Down",
        function()
            awful.client.focus.bydirection("down")
        end,
        { description = "focus down", group = "tag" }),
...
awful.keyboard.append_global_keybindings({
    awful.key({ modkey, "Shift" }, "Left",
        ...
        { description = "swap left", group = "tag" }),

    awful.key({ modkey, "Shift" }, "Right",
        function()
            awful.client.swap.byidx(1)
        end,
        { description = "swap right", group = "tag" }),

    awful.key({ modkey, "Shift" }, "Up",
        function()
            awful.client.swap.bydirection("up")
        end,
        { description = "swap up", group = "tag" }),

    awful.key({ modkey, "Shift" }, "Down",
        function()
            awful.client.swap.bydirection("down")
        end,
        { description = "swap down", group = "tag" }),
    ...
    awful.key({ modkey, }, "w", function() awful.layout.set(machi.default_layout) end,
        { description = "set machi layout", group = "client" }),
    ...
    awful.keyboard.append_client_keybindings({
        ...
        awful.key({ modkey, }, "m",
            function(c)
                ...
                if c.maximized then
                    c:relative_move(beautiful.useless_gap * 2, beautiful.useless_gap * 2, beautiful.useless_gap * -4, beautiful.useless_gap * -4)
                end
                c:raise()
            end,
        ...
        awful.key({ modkey, "Shift" }, "m",
            function(c)
                ...
                if c.maximized_vertical then
                    c:relative_move(0, beautiful.useless_gap * 2, 0, beautiful.useless_gap * -4)
                end
                c:raise()
            end,
            ...
            function(c)
                ...
                if c.maximized_horizontal then
                    c:relative_move(beautiful.useless_gap * 2, 0, beautiful.useless_gap * -4, 0)
                end
                c:raise()
            end,
